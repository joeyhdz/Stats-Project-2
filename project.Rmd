...
# removing sub_id, raterisk, bmi.cat, fracture.num
adj.training <- training[,-c(1,20)]
colnames(adj.training)
...
base.adj <- glm(fracture~priorfrac+age+bmi+raterisk+bonetreat, data = adj.training, family = "binomial")
