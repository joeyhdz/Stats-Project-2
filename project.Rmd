...
add.model.predprob <- predict(add.model,training, type = "prob")

# compute the ROC curve
add.model.roc <- roc(response = training$fracture, predictor = add.model.predprob$Yes, levels = c("Yes","No"))
...
confusionMatrix(pred_label, training$fracture)
